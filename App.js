...
const restroList=[
 ...
 const RestroCard=({id,name,cloudinaryImageId,avgRating,cuisines})=>{
    // const{id,name,img,rating,cuisines}=restro
    return(
        <div className="card">
         <img alt="card" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId}/>
         <h2>{name}</h2>
         <h3>{cuisines.join(", ")}</h3>
